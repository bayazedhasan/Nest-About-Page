...
const Footer = () => {
    return (
        <>
            ...
            <div className='border-b-2 mb-10 mt-15 container mx-auto px-6 border-gray-200'></div>

            <div className='flex justify-between items-center container mx-auto px-6 pb-10'>
                <div>
